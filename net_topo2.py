...
def Topology():
    ...
    ap1 = net.addAccessPoint('ap1', cls=OVSKernelAP13, ssid='ssid_1', channel='1', mode='g', position='116.0,529.0,0')
    ap2 = net.addAccessPoint('ap2', cls=OVSKernelAP13, ssid='ssid_2', channel='1', mode='g', position='787.0,517.0,0')
    ap3 = net.addAccessPoint('ap3', cls=OVSKernelAP13, ssid='ssid_3', channel='1', mode='g', position='1141.0,514.0,0')
    ...
    sta1 = net.addStation('sta1', ip='10.0.0.1', position='503.0,546.0,0')
